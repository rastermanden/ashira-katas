...
export const kumiteKataYon: Kata = {
  ...
  requiredForKyu: [2, 1],
  description: {
    en: 'Kumite no Kata Sono Yon is an advanced sparring form that incorporates jumping spinning kicks (tobi-geri) and extended combination sequences. The kata demands precision in executing hikikuzushi (off-balancing) and sophisticated entries for the throwing techniques.',
  ...
  steps: [
    ...
    },
    {
      ...
      defender: {
        en: 'Hidari stopping, migi gedan mawashi-geri, migi-hidari jodan nihon-tsuki, hidari jodan mawashi-geri, migi jodan ushiro mawashi-geri, migi jodan ushiro mawashi tobi-geri.',
        da: 'Hidari stopping, migi gedan mawashi-geri, migi-hidari jodan nihon-tsuki, hidari jodan mawashi-geri, migi jodan ushiro mawashi-geri, migi jodan ushiro mawashi tobi-geri.',
        ja: '左ストッピング、右下段回し蹴り、右左上段二本突き、左上段回し蹴り、右上段後ろ回し蹴り、右上段後ろ回し跳び蹴り。',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
    {
      ...
      attacker: {
        ...
        ja: '攻撃者は右前蹴りに続けて右突きを打ちます。',
      },
      defender: {
        en: 'Step back, hidari soto-uke + stopping, migi chudan mawashi-geri, hikikuzushi, migi chudan mawashi-geri. (Kick to the face but chudan height.)',
        da: 'Træd tilbage, hidari soto-uke + stopping, migi chudan mawashi-geri, hikikuzushi, migi chudan mawashi-geri. (Spark til ansigtet men chudan højde.)',
        ja: '後退して、左外受け＋ストッピング、右中段回し蹴り、引き崩し、右中段回し蹴り。（顔への蹴りだが中段の高さ。）',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
    ...
    },
    {
      ...
      defender: {
        en: 'Step back, hidari gedan-barai, migi soto-uke + migi gedan mawashi-geri, hidari chudan mawashi-geri x 2.',
        da: 'Træd tilbage, hidari gedan-barai, migi soto-uke + migi gedan mawashi-geri, hidari chudan mawashi-geri x 2.',
        ja: '後退して、左下段払い、右外受け＋右下段回し蹴り、左中段回し蹴り×2。',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
    ...
    },
    {
      ...
      defender: {
        en: 'Hidari hikkake, irimi (pos 4), ura-nage with migi hiza-geri to the back of head.',
        da: 'Hidari hikkake, irimi (pos 4), ura-nage med migi hiza-geri til bagsiden af hovedet.',
        ja: '左引っかけ、入り身（位置4）、裏投げ＋右膝蹴りで頭の後部を打つ。',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
    {
      ...
      defender: {
        en: 'Migi jodan-uke + migi jikuashi-geri, (mawashi-uke), hidari hiza-geri x 2, migi hiji-uchi.',
        da: 'Migi jodan-uke + migi jikuashi-geri, (mawashi-uke), hidari hiza-geri x 2, migi hiji-uchi.',
        ja: '右上段受け＋右軸足蹴り、（回し受け）、左膝蹴り×2、右肘打ち。',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
    {
      ...
      defender: {
        en: 'Jikuashi stopping, migi uchimomo-geri, migi jodan mawashi-geri, maki komi nage, kiba dachi.',
        da: 'Jikuashi stopping, migi uchimomo-geri, migi jodan mawashi-geri, maki komi nage, kiba dachi.',
        ja: '軸足ストッピング、右内腿蹴り、右上段回し蹴り、巻き込み投げ、騎馬立ち。',
      },
      technicalNotes: { en: '', da: '', ja: '' },
      schoolVariations: [],
    },
